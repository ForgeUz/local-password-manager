...
void main() {
  test('BackoffCalculator returns correct durations', () {
    ...
    expect(BackoffCalculator.nextDelay(9), equals(const Duration(seconds: 256)));
    expect(BackoffCalculator.nextDelay(10), equals(const Duration(seconds: 300)));
    expect(BackoffCalculator.nextDelay(15), equals(const Duration(seconds: 300)));
  });
}