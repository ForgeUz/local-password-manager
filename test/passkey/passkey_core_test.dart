...
void main() {
  group('M126: verifyRpId enforces FIDO2 domain isolation', () {
    test('exact match -> true', () {
      expect(
          PasskeyManager.verifyRpId(
              storedRpId: 'github.com', requestedRpId: 'github.com'),
          isTrue);
    });
    ...
    test('subdomain mismatch -> false', () {
      expect(
          PasskeyManager.verifyRpId(
              storedRpId: 'github.com', requestedRpId: 'evil.github.com'),
          isFalse);
    });
    ...
    test('different domain -> false', () {
      expect(
          PasskeyManager.verifyRpId(
              storedRpId: 'github.com', requestedRpId: 'gitlab.com'),
          isFalse);
    });
  });
}
