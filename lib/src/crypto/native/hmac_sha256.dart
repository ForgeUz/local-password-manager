...
typedef HmacNative = Int32 Function(Pointer<Void>, Pointer<Void>, Int64, Pointer<Void>);
typedef HmacDart = int Function(Pointer<Void>, Pointer<Void>, int, Pointer<Void>);
...
class HmacSha256 {
  ...
  static Uint8List compute(Uint8List key, Uint8List data) {
    ...
    try {
      ...
      final rc = hmac(out.cast<Void>(), dataPtr.cast<Void>(), data.length, keyPtr.cast<Void>());
